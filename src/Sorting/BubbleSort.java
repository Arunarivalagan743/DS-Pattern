...
public class BubbleSort {
    ...
    public static void BubbleSort(int[] a, int n) {
        ...
        {
            boolean swap = false;
            for(int j  =0;j<n-1-i;j++)  // for every pass the largest elemnt is  set at last..so dont need to  in future pass not need to check adjacent elemnts in next pass.. so(n - i - 1)
            {
